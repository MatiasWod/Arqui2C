...
section  .text
         global   binarySearch           ; Our program will start running from 'binarySearch'.
...
binarySearch:
        ...
        mov ebp,esp
         ...
         mov   dh, byte [ebp+8]            ; DH will hold the number we are searching ACA ESTA LO Q BUSCA
         lea   esi, [ebp+12]        ; Load effective address of 'arr' into esi.

while:
         xor   eax, eax          ; Reset eax to 0.
         xor   ebx, ebx          ; Reset ebx to 0.
         mov   ah, [left]        ; Get 'left' into ah.
         mov   al, [ebp+16]       ; Get 'right' into al.
